              ...
              <div className="inline-flex rounded-md shadow-sm" role="group">
                {availableYears.map(year => (
                  <button
                    key={year}
                    type="button"
                    className={`px-3 py-1.5 text-sm font-medium rounded-md ${selectedYear === year
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-gray-800">Available Product</h2>
              ...
              {allProducts.map((product) => (
                <tr key={product.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="bg-red-200 border-2 border-dashed rounded-xl w-12 h-12 mr-3" ><img src={product.productImage[1]} alt="" /></div>
                      <div className="text-md font-semibold font-popiens text-gray-900 break-words max-w-[340px]">
                        {product.productName}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-md font-semibold font-popiens">
                    {product.catagory }
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-md font-semibold font-popiens">
                    {(product.sellingPrice || 49.99)}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="px-2 inline-flex text-xs leading-5  rounded-full bg-green-100 text-green-800 text-md font-semibold font-popiens">
                      In Stock
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
